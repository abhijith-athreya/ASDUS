  ...
  var AJS = function () {
    ...
    _createClass(AJS, null, [{
        ...
        $selector.find('.item-ia').not('.mobile-header').css('visibility', 'hidden').each(function (idx, val) {
          ...
          if (tactic && AJS.tilerPREV.nPerRow > 1 && idx >= AJS.tilerPREV.nPerRow) {
            if (tactic === 3) {
              ...
              for (var _i2 = AJS.tilerPREV.nPerRow - 1; _i2 >= 0; _i2--) {
                ...
                var t1 = tops[_i2];
                var e = 0;
                for (e = 0; e < AJS.tilerPREV.nPerRow; e++) {
                  // eslint-disable-next-line  no-continue
                  if (e === _i2) continue;
                  if (t1 - $valHT > tops[e]) break; // nonideal
                }
                if (e === AJS.tilerPREV.nPerRow) {
                  log('BEST COL FOR #', idx, ' SO FAR: ', _i2);
                  col = _i2;
                }
              }
            } else if (tactic === 1) {
              // tactic #1: use column w/ highest up tops value but dont repeat/pick same prior column
              var mintop = Number.MAX_VALUE;
              for (var _i3 = 0; _i3 < AJS.tilerPREV.nPerRow; _i3++) {
                // eslint-disable-next-line  no-continue
                if (AJS.tilerPREV.nPerRow > 2 && _i3 === AJS.colPREV) continue;
                if (tops[_i3] < mintop) {
                  mintop = tops[_i3];
                  col = _i3;
                }
          ...
          // track how many tile images are without height (either not loaded or no CSS height
          // style set if img not loading from DB)
      ...
      value: function grafs() {
        ...
        var tok = '<h2>';
        $.get('/details/'.concat(identifier, '&grafs=1&v=2'), function (htm) {
          var a = htm.split(tok);
          if (a.length >= 3) {
      ...
      value: function about() {
        var aboutHide = function aboutHide() {
        ...
        $('.navbar-nav:first').on('mouseenter focusin', function (evt) {
          ...
          mousetimer = setTimeout(function () {
            ...
            // flank the IA logo!
            $('\n<div id="internet-archive" class="hidden-xs about-hider"\n     style="position:absolute; top:10px; width:100%; text-align:center;">\n  <div class="topinblock about-hider" style="width:100px; padding-left:10px;">\n    <div class="about-hider"\n         style="display:none; width:85px; height:30px; background:transparent -35px top no-repeat url(/images/footer.png)" />\n  </div><div class="topinblock about-hider" style="width:35px;height:1px;" /><div class="topinblock about-hider" style="width:100px;">\n    <div class="about-hider" style="display:none; width:85px; height:30px; background:transparent -116px top no-repeat url(/images/footer.png)" />\n  </div>\n</div>')
            // NOTE: put in *another* element so enter/leave events dont trigger for it --
            // since we're watching navbar-nav!
            );$('.navbar').prepend(
            // Now add in a 2nd level IA nav.  Poach the markup as it is in the "hamburger" / xs
            // dropdown: copy it and slightly remake it to what we want!
