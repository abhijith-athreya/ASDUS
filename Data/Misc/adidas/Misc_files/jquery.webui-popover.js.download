app.define('vendor/jquery.webui-popover', ['jquery'], function ($) {
    ...
    WebuiPopover.prototype = {
        ...
        */
        ...
        displayContent: function() {
            ...
            //$target.appendTo($('.floated-popup').eq(1));	
        ...
        */
        ...
        getTargetPositin: function(elementPos, placement, targetWidth, targetHeight) {
            var pos = elementPos,
                elementPosLeft = elementPos.left,
                de = document.documentElement,
                db = document.body,
                clientWidth = de.clientWidth,
                clientHeight = de.clientHeight,
            ...
            switch (placement) {
                case 'bottom':
                	...
                	arrowOffset = {
                    	left: validLeft ? (elementPosLeft + fixedW / 2) : _offsetOut
                    };
                    break;
                case 'top':
                    position = {
