...
/* eslint-disable */
// called from header.js: new PAYPAL.Marketing.HeaderMenu($('#menu-button'), $('#main-menu'));
...
$(function() {
  ...
  */
  ...
  /*
    Variables to handle user interaction
  */
  var currentWidth;
  var touchStartX;
  /**
  * closeSubMenus
  * Remove all open classes of sub-menus
  *
  **/
  function closeSubMenus() {
    $.each($menuItems, function(idx, itemLink) {
      $(itemLink).next('.menu-wrapper').removeClass('open');
    });
  }
  /**
  * removeLinkOpenClass
  ...
  **/
  ...
  /**
  * closeAll
  * removes all open state classes to trigger a real close
  * disableGradientAnimation
  * if true it will disable the gradient animation (for mobile)
  **/
  function closeAll(disableGradientAnimation) {
    if(!disableGradientAnimation) {
      $body.addClass('menu-close');
    }
    $body.removeClass('menu-open');
    $documentBody.removeClass('pp-header-open');
    closeSubMenus();
    removeLinkOpenClass();
  }
  /**
  ...
  **/
  ...
  /**
  * highlightHeader
  * highlight of header by matching current pathname to links within the menu bar
  *
  **/
  function highlightHeader() {
    ...
    if (path !== '/') {
      highlightLink = $menuBar.find("a[href*='" + path + "'][data-highlight]");
      if (highlightLink.length) {
        var attribute = highlightLink.data('highlight');
  ...
  /**
  * createCloser
  * creation of closer button in the header (far right 'X');
  *
  **/
  function createCloser(menuBar) {
    var closer = $(
      '<a><span class="accessAid">' +
        PP_GLOBAL_JS_STRINGS['CLOSE'] +
        '</span></a>'
    );
    closer.attr('href', '#' + PP_GLOBAL_JS_STRINGS['CLOSE']);
    closer.addClass('closer');
    closer.attr('role', 'button');
    closer.attr('title', PP_GLOBAL_JS_STRINGS['CLOSE']);
    closer.attr('data-pa-click', 'header|close');
    closer.on('click', function(e) {
      e.preventDefault();
      closeAll();
    });
    menuBar.find('.menu-wrapper').append(closer);
  }
  /**
  * attachEvents
  * Attach all UI events (open/close/keyboard)
  *
  **/
  function attachEvents() {
    // Initialize width to properly handle resize
    currentWidth = $(window).width();

    // Close menu on width change
    ...
    $menuButton.on('click', function(e) {
      ...
      $documentBody.toggleClass('pp-header-open');
    ...
    $menuItems.on('click', function(e) {
      ...
      if (
        ...
        $body.removeClass('menu-close');
        $documentBody.addClass('pp-header-open');
      } else {
        $body.addClass('menu-close');
        $body.removeClass('menu-open');
        $documentBody.removeClass('pp-header-open');
    ...
    // Event when clicking a submenu back link
    $menuItemsBack.on('click', function(e) {
      e.preventDefault();
      removeLinkOpenClass();
  ...
  function enableAccesibility() {
    var $menuWrapper = $('.menu-wrapper');
    $menuWrapper.attr('role', 'region');
  ...
  PAYPAL.Marketing.HeaderMenu = function(menuButton, menuBar) {
    ...
    $headerElem = $('header.pp-header');
    $menuItems = $menuBar.find('li > a[rel="menuitem"]');
    $menuItemsBack = $menuBar.find('.subnav > a');
    attachEvents();
    createCloser($menuBar);
    highlightHeader();
    enableAccesibility();
  };
});
