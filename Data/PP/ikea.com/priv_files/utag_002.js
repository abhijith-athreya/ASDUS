...
//tealium universal tag - utag.sender.7115 ut4.0.201609200954, Copyright 2016 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
    ...
    u.send = function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.data = {
          ...
          "google_conversion_id" : "1035699132",
          "pagetype" : "other",
          "value" : "",
          "send_ecom" : "yes",
        ...
        if (u.initialized) {
          ...
          if (!u.scriptrequested) {
            ...
            u.loader({"type": "script",  "src": u.data.base_url, "cb": u.callBack, "loc": "script", "id": 'utag_92' });
          }
        }
