...
//tealium universal tag - utag.sender.2045 ut4.0.201701091216, Copyright 2017 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
  ...
  u.extend=[];
    ...
    u.send = function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        if (!u.initialized) {
          u.loader({ "type" : "script", "src" : u.data.base_url, "cb" : u.loader_cb, "loc" : "script", "id" : "utag_116" });
        } else {
          u.loader_cb();
        }
