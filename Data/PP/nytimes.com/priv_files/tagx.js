...
TAGX.ScrollManager = (function () {
    ...
    var percentages = {25 : "25%", 50 : "50%", 75 : "75%", 100 : "100%"};
    ...
    scrollWatcher.pageWasScrolled = function (dir, howMuch, current) {
        ...
        if (scrollWatcher.subs && scrollWatcher.subs.length > 0) {
            ...
            for (s = scrollWatcher.subs.length - 1; s >= 0; s--) {
                sub = scrollWatcher.subs[s];
    ...
    scrollWatcher.trackScrollMilestones = function (callback) {
        scrollWatcher.addSubs({functionToRun: scrollWatcher.percentageGoals, args: {callback: callback, milestones: Object.keys(percentages)}});
    };   
