...
jQuery(document).ready(function(){jQuery("a.scorecard").fancybox({width:940,height:500,padding:0,helpers:{overlay:{css:{filter:"progid:DXImageTransform.Microsoft.gradient(startColorstr=#D2eeeeee,endColorstr=#D2eeeeee)",zoom:"1"}}}});
jQuery("a.scorecard").on("click",function(a){a.preventDefault();
jQuery.fancybox.open({padding:30,helpers:{overlay:{css:{filter:"progid:DXImageTransform.Microsoft.gradient(startColorstr=#D2eeeeee,endColorstr=#D2eeeeee)",zoom:"1"}}},wrapCSS:"fancybox-popup-content",autoDimensions:false,frameWidth:940,frameHeight:500})
})
});