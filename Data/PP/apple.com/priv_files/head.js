...
d.exports.FeatureDetect=c},{"./FeatureDetect":1,"./defaultTests":2,"ac-polyfills":64}],4:[function(d,f,b){var g=d("./ac-browser/BrowserData");
...
return}for(g=0;g<j.length;g++){d(h,j[g])}}},{"./className/add":9,"ac-polyfills/Array/prototype.slice":20,"ac-polyfills/Element/prototype.classList":21}],9:[function(b,c,a){var d=b("./contains");
...
return}for(g=0;g<j.length;g++){b(h,j[g])}}},{"./className/remove":12,"ac-polyfills/Array/prototype.slice":20,"ac-polyfills/Element/prototype.classList":21}],14:[function(b,c,a){c.exports={getWindow:function(){return window
...
}}}});return g}},{"ac-polyfills/Array/prototype.forEach":19}],19:[function(b,c,a){if(!Array.prototype.forEach){Array.prototype.forEach=function d(k,j){var h=Object(this);
var f;var g;if(typeof k!=="function"){throw new TypeError("No function object passed to forEach.")
}for(f=0;f<this.length;f+=1){g=h[f];k.call(j,g,f,h)}}}},{}],20:[function(b,c,a){(function(){var d=Array.prototype.slice;
try{d.call(document.documentElement)}catch(f){Array.prototype.slice=function(n,j){j=(typeof j!=="undefined")?j:this.length;
if(Object.prototype.toString.call(this)==="[object Array]"){return d.call(this,n,j)
}var l,h=[],k,g=this.length;var o=n||0;o=(o>=0)?o:g+o;var m=(j)?j:g;if(j<0){m=g+j
}k=m-o;if(k>0){h=new Array(k);if(this.charAt){for(l=0;l<k;l++){h[l]=this.charAt(o+l)
}}else{for(l=0;l<k;l++){h[l]=this[o+l]}}}return h}}}())},{}],21:[function(b,c,a){
...
}else{return d.call(this,h)}}}f=null}())}}},{}],22:[function(b,c,a){var d=b("./promise/promise").Promise;
...
}for(h=0;h<f;h+=1){if(h in j&&l.call(k,j[h],h,j)){g.push(j[h])}}return g}}},{}],37:[function(b,c,a){arguments[4][19][0].apply(a,arguments)
},{dup:19}],38:[function(b,c,a){if(!Array.prototype.indexOf){Array.prototype.indexOf=function d(g,h){var i=h||0;
...
k-=1}}return f}}},{}],43:[function(b,c,a){arguments[4][20][0].apply(a,arguments)
},{dup:20}],44:[function(b,c,a){if(!Array.prototype.some){Array.prototype.some=function d(k,j){var g=Object(this);
...
},{"./Element/prototype.classList":51}],51:[function(b,c,a){arguments[4][21][0].apply(a,arguments)
},{dup:21}],52:[function(b,c,a){b("./Function/prototype.bind")},{"./Function/prototype.bind":53}],53:[function(b,c,a){if(!Function.prototype.bind){Function.prototype.bind=function(d){if(typeof this!=="function"){throw new TypeError("Function.prototype.bind - what is trying to be bound is not callable")
...
}};window.getComputedStyle=function(h){return new a(h)}}},{}],67:[function(b,c,a){b("https://images.apple.com/v/privacy/e/scripts/html5shiv/src/html5shiv.js")
},{"https://images.apple.com/v/privacy/e/scripts/html5shiv/src/html5shiv.js":32}],68:[function(b,c,a){window.matchMedia=window.matchMedia||(function(i,j){var g,d=i.documentElement,f=d.firstElementChild||d.firstChild,h=i.createElement("body"),k=i.createElement("div");
...
return this}}}());c.exports=d.initialize()},{"ac-headjs":3}]},{},[71]);