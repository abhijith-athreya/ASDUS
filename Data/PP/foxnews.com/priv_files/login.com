...
if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = "432622663443889";
...
if (typeof janrain.settings.share.providers === 'undefined')janrain.settings.share.providers = ["facebook","twitter","linkedin"];
...
function getPackagePath(packages) {
    ...
    var path = rootPath + 'manifest/' + packages.join(':') + '?version=' + encodeURIComponent('release/1.115.2_widgets_573');
    return path;
}
